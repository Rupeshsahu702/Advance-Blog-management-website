    ...
    return (
        <div className='max-w-lg mx-auto w-full'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                <div className='relative w-32 h-32 self-center cursor-pointer overflow-hidden rounded-full shadow-md '
                    ...
                    <img
                        ...
                        ${imageFileUploadingProgress && imageFileUploadError < 100 && 'opacity-60'} `} />
                </div>
            ...
            <Modal show={showModal} onClose={() => setShowModal(fale)} popup size='md' >
                <Modal.Header />
                <Modal.Body>
